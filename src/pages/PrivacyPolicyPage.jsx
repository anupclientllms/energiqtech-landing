  ...
  return (
    <main className="legalPage">
      <section className="legalHero">
        ...
        <p>
          EnergIQ Tech is committed to protecting the privacy of customers,
      ...
      <section className="legalContent">
        ...
        <p>
          ...
          interest in any EnergIQ Tech software, source code, workflows, AI models,
        ...
        <p>
          ...
          EnergIQ Tech is not responsible for the privacy practices, content or
        ...
        <p className="legalDisclaimer">
          This Privacy Policy outlines how EnergIQ Tech collects, uses, stores and protects information provided by 

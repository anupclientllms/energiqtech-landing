    ...
    <main className="manufacturingPage">
      <section className="manufacturingHero">
        ...
        <motion.div className="manufacturingHeroContent" variants={stagger} initial="hidden" animate="show">
          ...
          <motion.p className="manufacturingHeroLead" variants={fadeUp}>
            EnergIQ Manufacturing AI connects production lines, CNC machines, air compressors, boilers, refrigeration systems, cold rooms, cooling towers, pumps, process fans, motors, conveyors, robotics, factory HVAC, lighting, charging infrastructure, solar and battery systems through the AI Energy Gateway.
          </motion.p>
      ...
      <section className="manufacturingSection manufacturingIntroSection">
        <div className="manufacturingSectionHeader">
          ...
          <span>Manufacturers must reduce electricity, gas and peak-demand costs without disrupting production, quality, safety or delivery schedules. EnergIQ provides one AI operating layer across production assets, industrial utilities and connected energy systems.</span>
        </div>
      ...
      <section className="manufacturingSection manufacturingScenariosSection">
        <div className="manufacturingSectionHeader">
          ...
          <span>Each scenario uses the same EnergIQ AI Energy Gateway, Digital Twin, Decision Agents and governed approval workflow.</span>
        </div>
      ...
      <section className="manufacturingSection manufacturingWorkflowSection" id="manufacturing-workflow">
        <div className="manufacturingSectionHeader manufacturingLightHeader">
          ...
          <span>EnergIQ transforms operational and energy data into explainable, measurable decisions while keeping production teams in control.</span>
        </div>
      ...
      <section className="manufacturingSection manufacturingPlatformSection">
        <div className="manufacturingPlatformPanel">
          <div className="manufacturingPlatformCopy">
            ...
            <h2>Manufacturing AI Is an Industry Pack Built on the Shared EnergIQ Architecture.</h2>
            <span>The same EnergIQ architecture supports commercial buildings, cold storage, warehouses, healthcare, universities, hotels, airports, data centres and distributed energy assets.</span>
